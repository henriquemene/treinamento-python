...
if numero3 > numero1 and numero3 > numero2:
    ...
    if numero1 < numero2 and numero1 < numero3:
        print(f"o numero menor dentre os que voce escolheu é o {numero1}")
if numero2 < numero1 and numero2 < numero3:
    print(f"o numero menor dentre os que voce escolheu é o {numero2}")
if numero3 < numero1 and numero3 < numero2:
    print(f"o numero menor dentre os que voce escolheu é o {numero3}")